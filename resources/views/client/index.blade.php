...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <h1 class="m-0 display-5 font-weight-semi-bold">Style<span class="text-primary font-weight-bold border px-3 mr-1">X</span></h1>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Nouvelle collection</span></h2>
        </div>
                ...
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        ...
                        <div class="d-flex justify-content-center">
                            <h6>{{$produit->prix_produit}}</h6><h6 class="text-muted ml-2"><del>$123.00</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="{{route('detailProduit', [$produit->id] )}}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Relooking complet</span></h2>
        </div>
