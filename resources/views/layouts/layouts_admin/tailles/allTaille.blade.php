 ...
 <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              @if (session()->has('success'))
               ...
               <div class="card">
                <h5 class="card-header">Tailles disponibles</h5>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu"> 
                              <a class="dropdown-item" href="{{route('showEditTaille', ['id'=> $item->id] )}}"
                                ><i class="bx bx-edit-alt me-2"></i> Edit</a
                              >
                              <a class="dropdown-item" href="{{route('deleteTaille', ['id'=> $item->id] )}}"
